      ...
      if (options.ci) {
        return Promise.all([
                           gitApi.post(`/projects/${repoId}/hooks`, {
                            url: `https://ci.dev.enyosolutions.com/project/${repoName}.wip`, push_events: true, tag_push_events: true, merge_requests_events: true
                          }),
                           gitApi.post(`/projects/${repoId}/hooks`, {
                            url: `https://ci.dev.enyosolutions.com/project/${repoName}.dev`, push_events: true, tag_push_events: true, merge_requests_events: true
                          }),
                           gitApi.post(`/projects/${repoId}/hooks`, {
                            url: `https://ci.dev.enyosolutions.com/project/${repoName}.staging`, push_events: true, tag_push_events: true, merge_requests_events: true
                          }),
